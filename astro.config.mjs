...
export default defineConfig({
  output: "static",
  site: "https://www.golmc.cz",
  integrations: [sitemap()],
  vite: {plugins: [tailwindcss()]},
  experimental: {fonts: [{provider: "local", name: "InterLocal", cssVariable: "--font-inter", variants: [
  ...
  }, {provider: "local", name: "InterLocalDisplay", cssVariable: "--font-inter-display", variants: [
